...
const ja: Translation = {
	...
	sourceVersion: "変換元のバージョン",
	targetVersion: "変換先のバージョン",
	autoDetected: "自動検出済み",
	uploadToAutoDetect: "ファイルをアップロードして自動検出",
